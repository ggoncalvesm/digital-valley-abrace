...
CREATE TABLE PESSOA (
		IDPESSOA INTEGER DEFAULT AUTOINCREMENT: start 1 increment 1 NOT NULL GENERATED ALWAYS AS IDENTITY  (START WITH 1 ,INCREMENT BY 1),
...
CREATE UNIQUE INDEX SQL171004085918720 ON PESSOA_FISICA (IDPESSOA ASC);
...
CREATE UNIQUE INDEX SQL171004085918540 ON PESSOA_JURIDICA (IDPESSOA ASC);
...
CREATE INDEX SQL171004085918541 ON PESSOA_JURIDICA (IDPESSOA ASC);

CREATE UNIQUE INDEX SQL171004090055050 ON DOACAO (IDDOACAO ASC);
...
CREATE INDEX SQL171004090055051 ON DOACAO (IDPESSOA ASC);
...
CREATE UNIQUE INDEX SQL171004085916050 ON PESSOA (IDPESSOA ASC);
...
CREATE INDEX SQL171004085919891 ON USUARIO (IDPESSOA ASC);
...
CREATE UNIQUE INDEX SQL171004085921050 ON ASSISTIDO (IDPESSOA ASC);
...
CREATE INDEX SQL171004085918721 ON PESSOA_FISICA (IDPESSOA ASC);
...
CREATE INDEX SQL171004085921051 ON ASSISTIDO (IDPESSOA ASC);

CREATE UNIQUE INDEX SYSCHECKS_INDEX1 ON SYSCHECKS (CONSTRAINTID ASC);

CREATE UNIQUE INDEX SQL171004085919890 ON USUARIO (IDPESSOA ASC);
...
ALTER TABLE PESSOA ADD CONSTRAINT SQL171004085916050 PRIMARY KEY (IDPESSOA);

ALTER TABLE PESSOA_FISICA ADD CONSTRAINT SQL171004085918720 PRIMARY KEY (IDPESSOA);

ALTER TABLE ASSISTIDO ADD CONSTRAINT SQL171004085921050 PRIMARY KEY (IDPESSOA);

ALTER TABLE DOACAO ADD CONSTRAINT SQL171004090055050 PRIMARY KEY (IDDOACAO);

ALTER TABLE PESSOA_JURIDICA ADD CONSTRAINT SQL171004085918540 PRIMARY KEY (IDPESSOA);

ALTER TABLE USUARIO ADD CONSTRAINT SQL171004085919890 PRIMARY KEY (IDPESSOA);

ALTER TABLE PESSOA_JURIDICA ADD CONSTRAINT SQL171004085918541 FOREIGN KEY (IDPESSOA)
	REFERENCES PESSOA (IDPESSOA)
	ON DELETE CASCADE;

ALTER TABLE PESSOA_FISICA ADD CONSTRAINT SQL171004085918721 FOREIGN KEY (IDPESSOA)
	REFERENCES PESSOA (IDPESSOA)
	ON DELETE CASCADE;

ALTER TABLE DOACAO ADD CONSTRAINT SQL171004090055051 FOREIGN KEY (IDPESSOA)
	REFERENCES PESSOA (IDPESSOA)
	ON DELETE CASCADE;

ALTER TABLE ASSISTIDO ADD CONSTRAINT SQL171004085921051 FOREIGN KEY (IDPESSOA)
	REFERENCES PESSOA_FISICA (IDPESSOA)
	ON DELETE CASCADE;

ALTER TABLE USUARIO ADD CONSTRAINT SQL171004085919891 FOREIGN KEY (IDPESSOA)
	REFERENCES PESSOA_FISICA (IDPESSOA)
	ON DELETE CASCADE;
